...
**Task** Run the following code and describe the dataframe it outputs. **Answer: A dataframe which includes gdp growth, population change, the majority vote in 2020, etc.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: There's a slightly positive correlation, but data points are sort of all over the place.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: A very slightly negative correlation, but again, the data points are all over the place.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: There is a negative correlation among each relationship, except for a slightly positive relationship between population change and gdp growth and vice versa.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: There is a -0.41 correlation, meaning the relationship is negative.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The test shows a very weak but negative correlation. Also the p-value is above .05, so this may not be a statistically significant test.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: Biden has a higher mean gdp growth and mean per pupil than Trump, but a lower mean population growth according to states voting in the 2020 election.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The p-value is 0.07, so this test may be statistically insignificant.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: This test is much stronger and the p-value is under 0.05, so this correlation is most likely statistically significant.**
