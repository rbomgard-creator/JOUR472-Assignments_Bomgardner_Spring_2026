...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer: They're both character datatype. Only two columns are shown.**
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer: Possible a caption of what each press release might entail.**
...
tags there are in the HTML source? **Answer: This suggests one ul tag.**
...
tags. Describe the output: **Answer: The text for each li.**
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer: We now have a dataframe with just the titles for each li.**
