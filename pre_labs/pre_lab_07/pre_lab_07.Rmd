...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer: Kent County had the largest margin of error for household income but holds the fourth to lowest median income of counties in Maryland. Also margin of error helps data be less definitive, like you can't say that Calvert County has a higher median income than Montgomery due to overlapping margins of error.**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer: Only 50 high schools had 60% or more its of graduates applying to college, along with a higher household income. 76 high schools had 40% or less of graduates applying to college, with a lower household income.**
...
**Task** What is another question you could ask of this data? **Answer: Do schools near community colleges show higher enrollment rates regardless of income, suggesting that proximity and affordability of local options matters? In order to do this I would need data on the community colleges in the state of Maryland, and possibly if they have dual-enrollment programs with nearby high schools.**
