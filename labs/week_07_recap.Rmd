...
**A11: By using a mutate function with case_when.**
...
**A12: Hour 6 and 17 have the most serious earthquakes, while hour 2 has the least.**:

------------------------------------------------------------------------

#### EXTRA Q What other questions are you interested in and how would you ask them in R?

Where do the strongest earthquakes happen most often?
```{r}
earthquakes |>
  filter(mag > 5) |>
...
Do earthquakes happen more often on certain days of the week?
```{r}
earthquakes |>
