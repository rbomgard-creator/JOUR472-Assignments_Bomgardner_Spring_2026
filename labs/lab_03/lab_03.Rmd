...
**A4:Funding for stem cell research heavily fluctuated throughout the years, and in some years, there is no money allocated to it.**
...
**A5: There are 17 grantees on this list. To make this data clean, I would need to make all grantee names uppercase for consistency. Then I would remove any sort of punctuation, make sure spelling is correct, and standardize abbreviations as well. What surprises me are the companies that do not have a University of Maryland name in their title. Like Zymetis Inc or Ovaltz Inc. Are these just companies that operate out of the College Park area or do they have something to do with the university?**

```{r}
umd_zip_grants <- md_grants_loans |>
